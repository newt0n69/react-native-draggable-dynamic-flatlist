...
class DraggableFlatList extends Component {
  ...
  animate = () => {
    ...
    const shouldScrollUp =
      this._move - this._containerOffset < this._containerSize * scrollRatio;
    const shouldScrollDown =
      this._move - this._containerOffset >
      this._containerSize * (1 - scrollRatio);
...
class RowItem extends React.PureComponent {
  ...
  render() {
    const { moveEnd, isActiveRow, horizontal, renderItem, item, index } =
      this.props;
